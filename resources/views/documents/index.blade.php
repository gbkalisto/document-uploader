                ...
                <div class="card-body p-4">
                    <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-area bg-light rounded-4 p-5 text-center border-2 border-dashed position-relative">
                                <input type="file" name="document" class="position-absolute w-100 h-100 top-0 start-0 opacity-0 cursor-pointer"
                                ...
                                <div id="fileSelected" class="d-none">
                                    ...
                                    <button type="button" class="btn btn-sm btn-link text-danger mt-2" onclick="resetFile()">Change File</button>
                                </div>
                            </div>
                        ...
                        <div class="bg-warning bg-opacity-10 border-start border-4 border-warning p-3 rounded-3 mb-4">
                            <div class="d-flex">
                                ...
                                <p class="small text-dark mb-0">
                                    <strong>Upload Guidelines:</strong> Max file size is 5 MB. Please use clear file names and ensure your document is in PDF, JPG, or PNG format.
                                </p>
                            </div>
                        </div>
