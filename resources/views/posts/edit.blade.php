            ...
            <div class="col-md-8"> {{-- Narrower column for forms feels more focused --}}
                ...
                <div class="d-flex justify-content-between align-items-end mb-4 shw">
                    <div>
                        ...
                        <p class="text-secondary mb-0">Update the details of your post below</p>
                    </div>
                        ...
                        <form action="{{ route('posts.update', $post->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="Enter a catchy title..." value="{{ old('title', $post->title) }}" required>
                                @error('title')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="subtitle" id="subtitle"
                                    ...
                                    placeholder="Enter a catchy subtitle..." value="{{ old('subtitle', $post->subtitle) }}" >
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="body" id="content" rows="6" class="form-control @error('body') is-invalid @enderror"
                                    placeholder="What's on your mind?" required>{{ old('body', $post->body) }}</textarea>
                                @error('body')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="d-flex gap-3 mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_published" id="publish"
                                        value="1" {{ old('is_published', $post->is_published) == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_published" id="draft"
                                        value="0" {{ old('is_published', $post->is_published) == 0 ? 'checked' : '' }}>
