            ...
            <div class="col-lg-10">
                <div class="card  shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white  py-4 px-4">
                        ...
                        <small class="text-muted">Modify the information for <strong>{{ $user->name }}</strong>
                            below.</small>
                    </div>
                        ...
                        <form action="{{ route('admin.customers.update', $user->id) }}" method="POST"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="address" rows="3" class="form-control bg-light  @error('address') is-invalid @enderror">{{ old('address', $user->profile->address ?? '') }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                <a href="{{ route('admin.customers.index') }}"
                                    class="btn btn-white  shadow-sm px-4">Cancel</a>
