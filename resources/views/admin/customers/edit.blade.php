                        ...
                        <form action="{{ route('admin.customers.update', $user->id) }}" method="POST"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted mt-1 d-block">Only fill these if you want to change the
                                        password.</small>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="address" rows="3" class="form-control bg-light @error('address') is-invalid @enderror"
                                        placeholder="Street, City, Country...">{{ old('address', $user->profile->address ?? '') }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
